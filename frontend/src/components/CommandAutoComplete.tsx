...
const COMMAND_SUGGESTIONS: CommandSuggestion[] = [
  { command: 'get cat fact', description: 'Get a random cat fact', category: 'Fun' },
  { command: 'get chuck joke', description: 'Get a Chuck Norris joke', category: 'Fun' },
  { command: 'search chuck', description: 'Search Chuck Norris jokes', category: 'Fun' },
  { command: 'get activity', description: 'Get a random activity suggestion', category: 'Fun' },
  { command: 'search github', description: 'Search GitHub users', category: 'Development' },
  { command: 'get weather', description: 'Get weather for a city', category: 'Weather' },
  { command: 'define', description: 'Get word definition', category: 'Reference' },
  { command: 'get my preferences', description: 'Get user preferences', category: 'User' },
  { command: 'save search', description: 'Save a search query', category: 'User' },
  { command: 'get search history', description: 'Get search history', category: 'User' },
